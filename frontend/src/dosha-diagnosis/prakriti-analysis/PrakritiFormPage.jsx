...
const questions = [
  {
    ...
    question:
      "How do you typically feel about weather changes?",
    options: [
  ...
  const calculateResult = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5000/api/prakriti/save",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            questionnaireScores,
            faceScores:
              JSON.parse(localStorage.getItem("faceResult")) || {
                Vata: 33,
                Pitta: 33,
                Kapha: 34,
              },
    ...
    <div className="min-h-screen bg-green-100 flex items-center justify-center p-6">
      <div className="bg-white rounded-3xl shadow-xl p-10 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="border rounded-xl p-6 shadow-sm">
            <h3 className="font-semibold mb-3">Lifestyle Practices</h3>
            <ul className="list-disc ml-5 text-sm space-y-2">
