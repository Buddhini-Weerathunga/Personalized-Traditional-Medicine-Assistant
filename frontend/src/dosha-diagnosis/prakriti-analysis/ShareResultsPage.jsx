// frontend/src/pages/ShareResultsPage.jsx
import { useNavigate } from "react-router-dom";

export default function ShareResultsPage() {
  const navigate = useNavigate();

  // Dummy values (same as result page for now)
  const vata = 62;
  const pitta = 25;
  const kapha = 13;
  const dominant = "Vata";
    ...
    <section className="pt-6 pb-10">
      ...
      <div className="bg-[#fdf7ef] rounded-2xl border border-[#e0cfba] shadow-lg p-6 space-y-5">
        ...
        <div>
          ...
          <ul className="text-sm text-[#7a5b3f] list-disc pl-5 space-y-1">
            <li>
              Diet: warm, nourishing meals; avoid skipping meals and late-night
              snacking.
            </li>
            <li>
              Routine: maintain steady sleep and wake times; include relaxation
              rituals.
            </li>
            <li>
              Wellness: gentle yoga, pranayama, oil massage, and mindful
              grounding practices.
            </li>
          </ul>
        </div>
