        ...
        <section className="relative max-w-6xl mx-auto px-4 pt-8 pb-12">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm md:text-base text-gray-700 mb-2 max-w-2xl leading-relaxed">
              Slightly open your mouth to show your teeth without forcing a big
              smile. Keep your jaw relaxed and avoid strong shadows around the
              lips.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 items-start">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-700">
                <strong>Instructions:</strong> Relax your jaw, open your mouth
                gently to show your teeth, and avoid stretching the lips too
                wide.
              </p>
            ...
            <div className="bg-white/85 rounded-2xl border border-green-100 shadow p-6 flex flex-col">
              <div className="flex-1 flex flex-col items-center justify-center mb-4">
                <div className="w-40 h-40 flex items-center justify-center mb-4">
                  <div className="w-32 h-20 border-2 border-emerald-200 rounded-full flex items-center justify-center bg-emerald-50/40">
                    <div className="w-24 h-8 border border-emerald-200 rounded-full" />
                  </div>
                </div>
                <p className="text-sm text-center text-gray-700">
                  Mouth and teeth features help assess dryness, lip shape,
                  cracks, and tension — key signs in understanding Vata (dry),
                  Pitta (inflamed), and Kapha (smooth, moist) tendencies.
                </p>
              </div>
