// frontend/src/dosha-diagnosis/prakriti-analysis/PrakritiAnalysisPage.jsx
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <Field
                ...
                name="Face_Width_Ratio"
                type="number"
                step="0.01"
                value={form.Face_Width_Ratio}
                onChange={handleChange}
              />
              <Field
                label="Jaw Width Ratio"
                name="Jaw_Width_Ratio"
                type="number"
                step="0.01"
                value={form.Jaw_Width_Ratio}
                onChange={handleChange}
              />
              <Field
                label="Forehead Height Ratio"
                name="Forehead_Height_Ratio"
                type="number"
                step="0.01"
                value={form.Forehead_Height_Ratio}
                onChange={handleChange}
              />
              <SelectField
                label="Eye Size"
              ...
              <SelectField
                label="Body Frame"
                name="Body_Frame"
                value={form.Body_Frame}
                onChange={handleChange}
                options={["Slim", "Medium", "Broad"]}
              />
              <Field
              ...
              <SelectField
                ...
                onChange={handleChange}
                options={["Regular", "Light", "Interrupted", "Deep"]}
              />
              <SelectField
