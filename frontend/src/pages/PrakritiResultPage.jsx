// frontend/src/pages/PrakritiResultPage.jsx
...
export default function PrakritiResultPage() {
  ...
  const barBase =
    "h-3 rounded-full bg-gradient-to-r from-[#f7e6cf] to-[#f1d9bf] overflow-hidden";
  const fillBase = "h-full rounded-full";
        ...
        <div className="bg-[#fdf7ef] rounded-2xl border border-[#e0cfba] shadow-lg p-6 space-y-5">
          ...
          <div className="bg-[#f7ecde] rounded-xl p-3 border border-[#ead4b8]">
            <p className="text-sm text-[#3e2b20]">
              ...
              typically creative, quick-thinking, and sensitive. When balanced,
              they are energetic and enthusiastic; when imbalanced, they may
              experience anxiety, dryness, or irregular routines.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm text-[#7a5b3f] list-disc pl-5 space-y-1">
              <li>Face shape slightly elongated – aligns with Vata qualities.</li>
              <li>
          ...
          <div>
            ...
            <ul className="text-sm text-[#7a5b3f] list-disc pl-5 space-y-1">
              ...
              <li>
                Herbs often used for Vata balancing include ashwagandha, licorice,
                and warm digestive teas.
              </li>
            </ul>
          </div>
