...
const connectDB = async () => {
  try {
    const conn = await mongoose.connect(process.env.MONGO_URI || "mongodb+srv://your-username:your-password@cluster.mongodb.net/yoga-therapy");
...
async function initializePoses() {
  ...
  ["left_knee", { min: 130, max: 170, ideal: 150 }],
    ...
    // 9. Eagle Arms Pose (Garudasana - Arms only)
    {
